...
const desktopModeProps = {
  ...
  "Home": {
    ...
    "Image13": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/6078b0cd748b8581836fddf5_Group%20334%20(1).png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox133": {
      "custom": {
        "text": "Over the past 12 years, I've worked with a diverse range "
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox135": {
      "custom": {
        "text": "of clients, from startups to Fortune 500 companies. I"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox136": {
      "custom": {
        "text": "love crafting interfaces that delight users  "
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image62": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/books_1f4da.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image63": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/briefcase_1f4bc.png"
      },
      "callbacks": {
        "onClick": [
          {
        ...
        "items": [
          {
            ...
            "icon": "/app-assets/6087cab3a74dfa369ea2e92a_Group%2084.svg"
          },
          {
            "title": "Music Mash",
            "description": "Information Architect",
            "icon": "/app-assets/6087cab3f70370b7efe8c560_Group%2085.svg"
          },
          {
            "title": "Kingdom",
            "description": "UI Designer",
            "icon": "/app-assets/6087cab33450e64d2fa55138_Group%2086.svg"
          }
        ]
      },
      "callbacks": {
    ...
    "TextBox212": {
      "custom": {
        "text": "didn't need a walkthrough. He"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox213": {
      "custom": {
        "text": "software so intuitive that it"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox229": {
      "custom": {
        "text": "Founder, Double Bunch Slide"
      },
      "callbacks": {
        "onClick": [
          {
  ...
  "new": {
    ...
    "TextBox19": {
      "custom": {
        "text": "hfvdgfegfuwfugejds iudfiewyfiwgf"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox18": {
      "custom": {
        "text": "i desiugjhgjegieyfkwewefiwo "
      },
      "callbacks": {
        "onClick": [
          {

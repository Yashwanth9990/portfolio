...
class Atri:
	def __init__(self, state: Any):
		...
		self.Checkbox1 = state["Checkbox1"]
		...
		self.VerticalMenu2 = state["VerticalMenu2"]
		self.Cascader2 = state["Cascader2"]
	...
	def Checkbox1(self, new_state):
		...
		global default_state
		self._Checkbox1 = Checkbox(new_state, default_state["Checkbox1"])
	...
	@property
	def VerticalMenu2(self):
		self._getter_access_tracker["VerticalMenu2"] = {}
		return self._VerticalMenu2
	@VerticalMenu2.setter
	def VerticalMenu2(self, new_state):
		self._setter_access_tracker["VerticalMenu2"] = {}
		global default_state
		self._VerticalMenu2 = VerticalMenu(new_state, default_state["VerticalMenu2"])

	@property
	def Cascader2(self):
		self._getter_access_tracker["Cascader2"] = {}
		return self._Cascader2
	@Cascader2.setter
	def Cascader2(self, new_state):
		self._setter_access_tracker["Cascader2"] = {}
		global default_state
		self._Cascader2 = Cascader(new_state, default_state["Cascader2"])
	...
	def _to_json_fields(self):
		return {
			...
			"VerticalMenu2": self._VerticalMenu2,
			"Cascader2": self._Cascader2,
...
class CheckboxcustomClass:
	def __init__(self, state, def_state):
		...
		self.checked: bool = get_defined_value(state, def_state, "checked")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
...
class Checkbox:
	def __init__(self, state, def_state):
		...
		self._def_state = def_state
		self.onChange = False
		self.styles: CheckboxstylesClass = get_defined_value(state, def_state, "styles")
		self.custom: CheckboxcustomClass = get_defined_value(state, def_state, "custom")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = CheckboxstylesClass(state, self._def_state["styles"])
	@property
	def custom(self):
		self._getter_access_tracker["custom"] = {}
		return self._custom
	...
	def custom(self, state):
		self._setter_access_tracker["custom"] = {}
		self._custom = CheckboxcustomClass(state, self._def_state["custom"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			"custom": self._custom,
